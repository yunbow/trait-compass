...
このページは、[self-check-methodology.md](./self-check-methodology.md) §1 で述べている
「開発者が事実確認(ファクトチェック)を行いながら整理してきた」設問の元データについて、
**カテゴリ単位で実際に参照した公的資料・学術論文を一覧化したもの**です。

## この一覧の位置づけ・限界

- 設問文自体は、開発者が管理する非公開の事実確認済みデータセット(242件、1件ごとに
  当事者視点・出典・確認日を記録)をもとに、本アプリ用の体験頻度アンケート文へ
  書き改めたものです。このデータセット自体は本リポジトリの範囲外のため公開していません。
- 以下の一覧は、そのデータセットの各項目(カテゴリ内の1件ごとの記録)が出典として
  参照していた公的機関ページ・学術論文を、**カテゴリ単位で集計・重複排除したもの**です。
  242問1問ずつを個別の文献に対応づけるものではありません。
- これらの資料は、各カテゴリで扱う特性・体験の**一般的な傾向を説明するもの**であり、
  本アプリの30問のセルフチェック(固定サブセット)そのものの信頼性・妥当性を検証した
  研究ではありません。臨床的妥当性・標準化が無いことは
...
| 種別 | 資料 |
| --- | --- |
| 二次資料 | [永瀬開（2017）自閉症スペクトラム障害者における情動調整に関する研究動向. 人間環境学研究 15(1)](https://www.jstage.jst.go.jp/article/shes/15/1/15_35/_article/-char/ja) |
...
| 二次資料 | [江口実希・國方弘子（2021）反すうの概念分析. 日本看護科学会誌 41](https://www.jstage.jst.go.jp/article/jans/41/0/41_41160/_html/-char/ja) |
| 二次資料 | [自閉スペクトラム症 - 発達障害情報のポータルサイト（厚生労働省・国立障害者リハビリテーションセンター）](https://hattatsu.go.jp/supporter/healthcare_health/about-asd-2/) |
| 二次資料 | [片桐正敏（2019）適応機能としての自閉症スペクトラム障害の注意と感覚処理特性. 心理学評論 62(1)](https://www.jstage.jst.go.jp/article/sjpr/62/1/62_25/_article/-char/ja/) |
...
| 二次資料 | [注意欠如多動症 - 発達障害情報のポータルサイト（厚生労働省・国立障害者リハビリテーションセンター）](https://hattatsu.go.jp/supporter/healthcare_health/about-adhd-2/) |
| 二次資料 | [タイムスリップ現象（精神科用語シソーラス） - 日本精神病理学会](https://sites.google.com/psychopathology.jp/thesaurus/%E8%87%AA%E9%96%89/%E3%82%BF%E3%82%A4%E3%83%A0%E3%82%B9%E3%83%AA%E3%83%83%E3%83%97%E7%8F%BE%E8%B1%A1) |

## 衝動・記憶 (`impulse-memory`)
...
| 種別 | 資料 |
| --- | --- |
| 一次資料(学術論文) | [池田一成（2023）自閉スペクトラム症に見られる感覚処理障害の臨床神経生理学. 臨床神経生理学 51(2)](https://www.jstage.jst.go.jp/article/jscn/51/2/51_68/_article/-char/ja/) |
| 二次資料 | [自閉スペクトラム症 - 発達障害情報のポータルサイト（厚生労働省・国立障害者リハビリテーションセンター）](https://hattatsu.go.jp/supporter/healthcare_health/about-asd-2/) |
| 二次資料 | [片桐正敏（2019）適応機能としての自閉症スペクトラム障害の注意と感覚処理特性. 心理学評論 62(1)](https://www.jstage.jst.go.jp/article/sjpr/62/1/62_25/_article/-char/ja/) |
| 二次資料 | [注意欠如多動症 - 発達障害情報のポータルサイト（厚生労働省・国立障害者リハビリテーションセンター）](https://hattatsu.go.jp/supporter/healthcare_health/about-adhd-2/) |
| 二次資料 | [自閉スペクトラム症者の感覚過敏―刺激の時間処理特性との関連― 国立障害者リハビリテーションセンター研究所 脳機能系障害研究部 発達障害研究室（研究所セミナー業績）](https://www.rehab.go.jp/achievements/japanese/33th/54.pdf) |
| 一次資料(学術論文) | [岡本康秀ほか（2022）「聞き取り困難」における聴覚特性と背景要因. 日本耳鼻咽喉科頭頸部外科学会会報 125(7)](https://www.jstage.jst.go.jp/article/jibiinkotokeibu/125/7/125_1092/_article/-char/ja/) |
...
| 種別 | 資料 |
| --- | --- |
| 二次資料 | [発達性協調運動症 - 発達障害情報のポータルサイト（厚生労働省・国立障害者リハビリテーションセンター）](https://hattatsu.go.jp/supporter/healthcare_health/about-dcd/) |
| 二次資料 | [信迫悟志（2025）子どもの運動の不器用さ（発達性協調運動症DCD）に挑戦する. 奈良理学療法学 17](https://www.jstage.jst.go.jp/article/nararigakuryohogaku/17/0/17_18/_article/-char/ja) |
| 一次資料(学術論文) | [池田一成（2023）自閉スペクトラム症に見られる感覚処理障害の臨床神経生理学. 臨床神経生理学 51(2)](https://www.jstage.jst.go.jp/article/jscn/51/2/51_68/_article/-char/ja/) |
| 一次資料(学術論文) | [杉本明子（2022）日本語ディスレクシア児の書字障害に関する研究─尺度構成ならびに認知障害とサブタイプの検討─. 教育心理学研究 70(4)](https://www.jstage.jst.go.jp/article/jjep/70/4/70_347/_article/-char/ja/) |
| 二次資料 | [竹内謙彰（1990）「方向感覚質問紙」作成の試み(1)─質問項目の収集及び因子分析結果の検討─. 愛知教育大学研究報告 教育科学 39](https://cir.nii.ac.jp/crid/1050001338436471168) |
| 二次資料 | [発達性協調運動症 - 一般社団法人 小児心身医学会（細かい力加減・力の入れ方/抜き方の困難に言及）](https://www.jisinsin.jp/general/typical_diseases/%E7%99%BA%E9%81%94%E6%80%A7%E5%BC%B7%E8%AA%BF%E9%81%8B%E5%8B%95%E7%97%87/) |

## 学習・読み書き計算 (`learning`)

| 種別 | 資料 |
| --- | --- |
| 二次資料 | [限局性学習症（SLD） - 合理的配慮ハンドブック（独立行政法人日本学生支援機構JASSO、文部科学省の定義に基づく）](https://www.jasso.go.jp/gakusei/tokubetsu_shien/shogai_infomation/handbook/08/01-3.html) |
| 二次資料 | [湯澤正通（2019）ワーキングメモリの発達と児童生徒の学習：読み書き・算数障害への支援. 発達心理学研究 30(4)](https://www.jstage.jst.go.jp/article/jjdp/30/4/30_188/_article/-char/ja) |
| 一次資料(学術論文) | [秋元有子（2017）数学的思考の視点から見た算数障害. 教育心理学研究 65(1)](https://www.jstage.jst.go.jp/article/jjep/65/1/65_106/_article/-char/ja/) |
| 二次資料 | [発達性ディスレクシアとは（ファクトシート） - 発達性ディスレクシア研究会](https://square.umin.ac.jp/dyslexia/factsheet.html) |
| 一次資料(学術論文) | [安村明（2014）ADHDの診断プログラムの提案─実行機能障害の観点から─. 認知神経科学 16(2)](https://www.jstage.jst.go.jp/article/ninchishinkeikagaku/16/2/16_115/_article/-char/ja/) |
| 二次資料 | [片桐正敏（2019）適応機能としての自閉症スペクトラム障害の注意と感覚処理特性. 心理学評論 62(1)](https://www.jstage.jst.go.jp/article/sjpr/62/1/62_25/_article/-char/ja/) |
| 一次資料(学術論文) | [杉本明子（2022）日本語ディスレクシア児の書字障害に関する研究─尺度構成ならびに認知障害とサブタイプの検討─. 教育心理学研究 70(4)](https://www.jstage.jst.go.jp/article/jjep/70/4/70_347/_article/-char/ja/) |

## こだわり・反復 (`restricted-repetitive`)
...
| 二次資料 | [自閉スペクトラム症の子どもの特性 - すまいるナビゲーター（大塚製薬）「儀式的行為として毎日同じ道順をたどることにこだわり、小さな変化に極度の苦痛」](https://www.smilenavigator.jp/asd/abc/02.html) |
| 二次資料 | [松本英夫「ASD（自閉スペクトラム症）」を訊く - 公益社団法人 日本精神神経学会（診断基準B「常同的または反復的な物の使用／同一性への固執」）](https://www.jspn.or.jp/modules/forpublic/index.php?content_id=55) |
| 二次資料 | [各障害の定義（自閉症） - 国立障害者リハビリテーションセンター「限定した常同的な興味、行動および活動」](https://www.rehab.go.jp/ddis/understand/definition/) |
| 二次資料 | [藤岡徹「自閉スペクトラム症の認知機能」LD研究 26巻4号（2017）「ASD傾向を規則性に当てはめてものごとを理解する傾向とする共感－システム化理論」](https://www.jstage.jst.go.jp/article/jald/26/4/26_474/_article/-char/ja) |
| 二次資料 | [髙木美歩「心理学分野の自閉症スペクトラム障害研究における障害観の変化と揺らぎ」Core Ethics Vol.16（2020）（共感化－システム化理論／システム化傾向の議論）](https://www.r-gscefs.jp/wp-content/uploads/2020/04/%E3%82%B3%E3%82%A2%E3%83%BB%E3%82%A8%E3%82%B7%E3%83%83%E3%82%AF%E3%82%B916%E5%8F%B7_11_%E9%AB%99%E6%9C%A8%EF%BC%88%E8%AB%96%E6%96%87%EF%BC%89.pdf) |
| 二次資料 | [自閉スペクトラム症 - 発達障害情報のポータルサイト（厚生労働省・国立障害者リハビリテーションセンター）「特定の物事に過度に熱中しやすく知識も豊富となる傾向」](https://hattatsu.go.jp/supporter/healthcare_health/about-asd-2/) |
| 二次資料 | [松本英夫「ASD（自閉スペクトラム症）」を訊く - 公益社団法人 日本精神神経学会（診断基準B「きわめて限定され執着する興味」）](https://www.jspn.or.jp/modules/forpublic/index.php?content_id=55) |
| 二次資料 | [日本発達心理学会 言語発達分科会 シンポジウム「エコラリアの意味を問い直す―発達支援のために―」](https://jsdp.jp/uploads/about/branch/devlang2010.pdf) |
| 二次資料 | [自閉スペクトラム者のエコラリアに込められた心情に着目したアプローチの検討. 兵庫教育大学 学校教育学研究 第35巻](https://hyogo-u.repo.nii.ac.jp/record/16694/files/gakkokyoiku_vol35_22.pdf) |

---
設問の設計方針・スコア計算・限界については [self-check-methodology.md](./self-check-methodology.md) を、アプリ全体の概要は [technical-overview.md](./technical-overview.md) を参照してください。
